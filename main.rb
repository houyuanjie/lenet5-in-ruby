...
Mnist.install_to('./model/dataset/MNIST/raw')

train_images = Mnist.load_images('./model/dataset/MNIST/raw/train-images-idx3-ubyte')
...
train_labels = Mnist.load_labels('./model/dataset/MNIST/raw/train-labels-idx1-ubyte')
puts "train_labels: num_labels=#{train_labels.num_labels}"

test_images = Mnist.load_images('./model/dataset/MNIST/raw/t10k-images-idx3-ubyte')
...
test_labels = Mnist.load_labels('./model/dataset/MNIST/raw/t10k-labels-idx1-ubyte')
